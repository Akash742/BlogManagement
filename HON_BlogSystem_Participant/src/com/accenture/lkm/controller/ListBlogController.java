...
public class ListBlogController {
	...
	*/
	...
	public ModelAndView listPosts(@ModelAttribute("blog") BlogBean bean) throws Exception {
		ModelAndView mv = new ModelAndView();
		List<BlogBean> beanList = blogService.getAllPosts(bean.getEmail());
		if(!beanList.isEmpty()) {
			
			mv.setViewName("Report");
			mv.addObject("blogList", beanList);
		}
		else
		{
			mv.setViewName("ListPosts");
		}
		return mv;
	}
