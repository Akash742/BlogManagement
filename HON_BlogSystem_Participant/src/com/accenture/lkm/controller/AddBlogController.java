...
public class AddBlogController {
	...
	public Map<String, String> populateTheme() {
		...
		theme = blogService.populateTheme();
		return theme;
	}
  /**
	...
	*/
	...
	public ModelAndView addBlog(@ModelAttribute("blog") @Valid BlogBean bean, BindingResult res) throws Exception {
		...
		{
			mv.setViewName("NewBlog");
			int i = blogService.addBlog(bean);
			mv.addObject("MESSAGE", "Blog Added Successfully with ID: " + i);
